                ...
                <div class="kt-portlet kt-portlet--height-fluid kt-portlet--mobile ">
                    <div class="kt-portlet__head kt-portlet__head--lg kt-portlet__head--noborder kt-portlet__head--break-sm">
                        ...
                        <div class="kt-portlet__head-toolbar">
                            @can('Create Pages')
                                <a href="{{ route('backend.gallery.create') }}" class="btn btn-primary">إضافة صورة جديدة</a>
                            @endcan
                        </div>
                    </div>
                            ...
                            <table id="clientSideDataTable" class="display" style="width:100%;" class="table table-bordered dt-responsive">
                                ...
                                @foreach ($list as $cat)
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdesign">
                                            <img width="100" src="{{optional($cat->getFirstMedia('images'))->getUrl()}}">
                                        </td>

                                        <td class="tdesign">

                                            @can('Edit Pages')
                                                <a href="{{ route('backend.gallery.edit',$cat->id) }}" class="bluebutton" ><i class="fa fa-edit"></i></a>&nbsp;
                                            @endcan

                                            @can('Delete Pages')
                                                <a title="Delete" href="#" data-action="{{route('backend.gallery.destroy',$cat->id)}}" class="redbutton deleteRecord"><i class="fa fa-trash"></i></a>
                                            @endcan
                                        </td>
                                    </tr>
                                @endforeach
