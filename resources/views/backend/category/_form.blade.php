<div class="row">
    ...
    <div class="col-lg-6">
        <div class="form-group">
            ...
            <input required value="{{old('name.'.$localeKey)?old('name.'.$localeKey):isset($category)?$category->getTranslation('name',$localeKey):''}}" name="name[{{$localeKey}}]" type="name" class="form-control" id="name-{{$localeKey}}" placeholder="Enter Name">
        </div>
    </div>
    @endforeach
</div>
<div class="row">
    <div class="col-lg-12">
        <div class="form-group">
            <label for="parent">@lang('tr.Parent')</label>
...
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            <label>
                <input @if($category->show_in_home) checked @endif name="show_in_home" type="checkbox" class="form-control">
                Show In Filter
            </label>
        </div>
    </div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="form-group">
            ...
            @if($category->id)
            <div class="mt-2">
                <img width="100px" src="{{optional($category->getFirstMedia('images'))->getUrl()}}"/>
            </div>
            @endif
        </div>
    </div>
