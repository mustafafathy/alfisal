            ...
            <div class="kt-portlet ">
                <div class="kt-portlet__body">
                    <div class="row" style="margin-bottom: 10px;">
                        <div class="col-md-3">
                            <i style="color: #fd397a;" class="fa fa-square"></i> الطلبات
                        </div>
                        <div class="col-md-3">
                            <i style="color: #008000;" class="fa fa-square"></i>  مهمات مبتدئة
                        </div>
                        <div class="col-md-3">
                            <i style="color: #FF9800;" class="fa fa-square"></i> مهمات قيد الانتظار
                        </div>
                        <div class="col-md-3">
                            <i style="color: #0000ff;" class="fa fa-square"></i> مهمات مكتملة
                        </div>
                    </div>
