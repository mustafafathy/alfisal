                ...
                <div class="kt-portlet kt-portlet--height-fluid kt-portlet--mobile ">
                    <div class="kt-portlet__head kt-portlet__head--lg kt-portlet__head--noborder kt-portlet__head--break-sm">
                        ...
                        <div class="kt-portlet__head-toolbar">
                            @can('Create Pages')
                                <a href="{{ route('backend.pages.create') }}" class="btn btn-primary">إضافة صفحة جديدة</a>
                            @endcan
                        </div>
                    </div>
                                ...
                                @foreach ($list as $cat)
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdesign">
                                            ...
                                            @can('Edit Pages')
                                                <a href="{{ route('backend.pages.edit',$cat->id) }}" class="bluebutton" ><i class="fa fa-edit"></i></a>&nbsp;
                                            @endcan

                                            @can('Delete Pages')
                                                <a title="Delete" href="#" data-action="{{route('backend.pages.destroy',$cat->id)}}" class="redbutton deleteRecord"><i class="fa fa-trash"></i></a>
                                            @endcan
                                        </td>
                                    </tr>
                                @endforeach
